...
{	
	public class ChestSpawn : ModSystem
	{
		...
		public static void ResetSet() {
			#region PreHardmode
			/*Surface*/mySet.AddChestPool(0, new int[] {0, 12, ItemID.WoodenCrate, ItemID.WoodenCrateHard}, new int[] {280, 281, 284, 285, 953, 946, 3068, 3069, 3084, 4341, ItemID.BabyBirdStaff});
			...
			/*Dungeon*/mySet.AddChestPool(0, new int[] {2, ItemID.DungeonFishingCrate, ItemID.DungeonFishingCrateHard}, new int[] {ItemID.Handgun, ItemID.AquaScepter, ItemID.MagicMissile, ItemID.BlueMoon, ItemID.CobaltShield, ItemID.Muramasa, ItemID.Valor});
			/*Hell*/mySet.AddChestPool(0, new int[] {4, ItemID.LavaCrate, ItemID.LavaCrateHard}, new int[] {ItemID.Sunfury, ItemID.FlowerofFire, ItemID.Flamelash, ItemID.DarkLance, ItemID.HellwingBow});
			...
			/*Tentacle Spike Corr.*/mySet.AddRulePool(0, new int[] {956, 7, NPCID.BloodCrawler, NPCID.Crimera, NPCID.FaceMonster}, new int[] {5094});
			...
			/*Shadow Orb*/mySet.AddSmashPool(0, new int[] {ItemID.Musket, ItemID.ShadowOrb, ItemID.Vilethorn, ItemID.BallOHurt, ItemID.BandofStarpower});
			...
			/*Skeletron*/mySet.AddRulePool(0, new int[] {NPCID.SkeletronHead}, new int[] {ItemID.BookofSkulls}, 2);
        ...
        public override void PostWorldGen() 
		{
			...
			if (WorldGen.crimson) {
				...
				mySet.GetRulePools(13)[0].IsEnabled = false;
				mySet.GetRulePools(6)[0].IsEnabled = false;
			} else {
				mySet.GetRulePools(NPCID.BrainofCthulhu)[0].IsEnabled = false;
			}
			mySet.Randomize();
        ...
        {
            Console.WriteLine(ChestSpawn.mySet.shopSet.Values.ToList()[0].randomSet.Length != 0);
        }
    }
